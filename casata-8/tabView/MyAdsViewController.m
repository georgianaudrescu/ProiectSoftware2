...
- (void) animateTextField: (UITextField*) textField up: (BOOL) up
{
    ...
    self.dateContact.frame = CGRectOffset(self.dateContact.frame, 0, movement);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    */
    ...
    if ([apdelegate.appSession.user.personalAds count] == 0)
    {
        cell.textLabel.text = @"Nu exista anunturi in lista";
    }
    else
    {
        ...
        if(tempAd.thumb==nil)
        {cell.imageView.image = [UIImage imageNamed:@"thumbMyDefault.png"];}
        else
